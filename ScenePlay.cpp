...
void ScenePlay::updateWeaponState()
{
...
void ScenePlay::updateScore(std::shared_ptr<Entity> entity)
{
	if (!entity)
	{
...
void ScenePlay::showScore()
{
	m_text.setString("Score: " + std::to_string(m_score));
}
void ScenePlay::showHighScore()
{
...
void ScenePlay::spawnSmallEnemies(std::shared_ptr<Entity> e)
{
...
void ScenePlay::spawnBullet(std::shared_ptr<Entity> entity, const Vec2& target)
{
...
void ScenePlay::spawnSpecialWeapon()
{
